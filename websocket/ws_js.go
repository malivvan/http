...
import (
	...
	"github.com/malivvan/http/websocket/wsjs"
)
...
//
// All fields except Subprotocols are no-ops on WASM: the browser
// manages the connection and the handshake.
type DialOptions struct {
	// HTTPClient is used for the connection.
	// No-op on WASM; the browser manages the connection.
	HTTPClient *http.Client

	// HTTPHeader specifies the HTTP headers included in the handshake request.
	// No-op on WASM; the browser manages request headers.
	HTTPHeader http.Header

	// Host optionally overrides the Host HTTP header to send.
	// No-op on WASM.
	Host string
	...
	// OnPingReceived is an optional callback invoked when a ping frame is received.
	// No-op on WASM.
	OnPingReceived func(ctx context.Context, payload []byte) bool

	// OnPongReceived is an optional callback invoked when a pong frame is received.
	// No-op on WASM.
	OnPongReceived func(ctx context.Context, payload []byte)

	// PrepareRequest is an optional callback invoked before the handshake request is sent.
	// No-op on WASM; the browser controls the handshake.
	PrepareRequest func(r *http.Request) error

	// HeaderOrder specifies the order in which HTTP headers appear in the handshake request.
	// No-op on WASM; the browser controls header order.
	HeaderOrder []string
}
...
//
// All callback fields are no-ops on WASM as Accept is unimplemented.
type AcceptOptions struct {
	...
	// OnPingReceived is a no-op on WASM since Accept is unimplemented.
	OnPingReceived func(ctx context.Context, payload []byte) bool

	// OnPongReceived is a no-op on WASM since Accept is unimplemented.
	OnPongReceived func(ctx context.Context, payload []byte)

	// OnRequest is a no-op on WASM since Accept is unimplemented.
